<template>
  <div class="totalorder-container">
    ...
    <div class="twoheight1">
      ...
      >
        ...
        <el-table-column label="状态" width="150">
          <template slot-scope="scope">
            <p :class="'statu' + scope.row.state">
              {{ logisticsStatu(scope.row.state) }}
            </p>
          </template>
        </el-table-column>
    ...
    <forecast-detail ref="forecastDetailRef"></forecast-detail>
  </div>
</template>
...
import ForecastDetail from '@/components/common/ForecastDetail.vue'
export default {
  ...
  methods: {
    ...
    handleReview(id) {
      this.$refs.forecastDetailRef.openDialogVisible(id)
    },
